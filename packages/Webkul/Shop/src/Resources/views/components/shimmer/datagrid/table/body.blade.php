...
@for ($i = 0;  $i < 10; $i++)
    @if (! $isMultiRow)
        <div class="row grid grid-cols-6 gap-2.5 border-b border-border px-4 py-4 text-muted">
    ...
    @else
        <div class="row grid grid-cols-[2fr_1fr_1fr] gap-2.5 border-b border-border px-4 py-2.5 text-muted">
