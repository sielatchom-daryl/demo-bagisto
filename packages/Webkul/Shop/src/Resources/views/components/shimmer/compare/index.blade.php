...
<div class="grid mt-16 overflow-auto journal-scroll max-md:mt-7">
    <!-- Single row -->
    @for ($i = 1; $i <= $attributeCount; $i++)
        <div class="flex items-center max-w-full border-b border-border">
            <div class="min-w-[304px] max-w-full max-md:min-w-40 max-sm:min-w-[110px]">
                <p class="shimmer h-[21px] w-[55%]"></p>
            </div>

            <div class="flex gap-3 border-border max-md:gap-0 max-sm:border-0 ltr:border-l rtl:border-r">
