                ...
                <x-shop::form :action="route('shop.customer.session.create')">
                    ...
                    <div class="flex justify-between">
                        <div class="flex select-none items-center gap-1.5">
                            ...
                            <label
                                class="text-2xl cursor-pointer icon-uncheck peer-checked:icon-check-box text-primary peer-checked:text-primary max-sm:text-xl"
                                for="show-password"
                            ></label>
                        ...
                        <div class="block">
                            <a
                                ...
                                class="text-base cursor-pointer text-foreground max-sm:text-sm"
                            >
                                <span>
